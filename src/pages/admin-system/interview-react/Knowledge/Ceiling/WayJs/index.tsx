...
const WayJs = () => {
  ...
  useEffect(() => {
    const handleSroll = (e: any) => {
      ...
      const offsetTop = refJsChild?.current?.offsetTop; 
      // offsetTop是固定值，值是距离最近的具有位置属性的祖先元素之间的距离
      // console.log('scrollTop :>> ', scrollTop);
      // console.log('offsetTop :>> ', offsetTop);
      // 1. 如果 scrollTop > offsetTop 证明子元素已经到达了最顶部，可以把置换的DOM显示出来了
