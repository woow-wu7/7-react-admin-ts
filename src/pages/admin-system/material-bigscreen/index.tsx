  ...
  return (
    <div className={styles.matarialBigScreen}>
      ...
      <div className={styles.plugins}>
        ...
        <a href="https://blog.csdn.net/sinat_17775997/article/details/106465327" target="_blank">(3) echarts改变主题</a>
        <a href="https://www.cnblogs.com/zhangnan35/p/12680038.html" target="_blank">(4) vue中 echarts的封装</a>
      </div>
    </div>
  )
}
