...
export function genDOMPropSegments(props: Array<ASTAttr>, attrs: ?Array<ASTAttr>): Array<StringSegment> {
  const segments = []
...
export function genClassSegments(staticClass: ?string, classBinding: ?string): Array<StringSegment> {
